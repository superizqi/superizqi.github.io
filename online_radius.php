                  ...
                  <form class="form-inline">
                    <div class="form-group">
                      ...
                      <select class="form-control">
                        <OPTION SELECTED value=></OPTION><OPTION value='32'>NAS-BIT</OPTION><OPTION value='30'>NAS-c204</OPTION><OPTION value='33'>NAS-csg</OPTION><OPTION value='31'>NAS-mars</OPTION>
                      </select>
                      <label>AP</label>
                      <select class="form-control">
                        <OPTION SELECTED value=></OPTION><OPTION value='2'>AP c204</OPTION><OPTION value='1'>AP-mars</OPTION>

                      </select>
                      <label>Group</label>
                      <select class="form-control">
                        <OPTION SELECTED value=></OPTION><OPTION value='1'>Default group</OPTION><OPTION value='4'>Full</OPTION><OPTION value='3'>NAS 1</OPTION><OPTION value='2'>Upstream 1</OPTION>
                      </select>
                      <label>User Name</label>
                      <input class="form-control" type="text" class="normal" id="filterusername" value="">
                    </div>
                  </form>
                ...
                <table class="table">
                  ...
                  <form class="form-inline">
                    <div class="form-group">
                      ...
                      <label>*Free traffic / time included   *Disabled</label>
                    </div>
                  </form>
